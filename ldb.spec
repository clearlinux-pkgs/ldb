...
Source0  : https://www.samba.org/ftp/pub/ldb/ldb-1.5.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1550788587
...
/usr/lib64/libpyldb-util.cpython-37m-x86-64-linux-gnu.so.1.5.3

%files lib
%defattr(-,root,root,-)
%exclude /usr/lib64/ldb/modules/ldb/ldb.so
%exclude /usr/lib64/libpyldb-util.cpython-37m-x86-64-linux-gnu.so.1
%exclude /usr/lib64/libpyldb-util.cpython-37m-x86-64-linux-gnu.so.1.5.3
