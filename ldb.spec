...
Version  : 2.3.0
Release  : 69
URL      : https://www.samba.org/ftp/pub/ldb/ldb-2.3.0.tar.gz
Source0  : https://www.samba.org/ftp/pub/ldb/ldb-2.3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617644685
...
cp %{_builddir}/ldb-2.3.0/third_party/popt/COPYING %{buildroot}/usr/share/package-licenses/ldb/61bb7a8ea669080cfc9e7dbf37079eae70b535fb
%make_install
...
/usr/lib64/libpyldb-util.cpython-39-x86-64-linux-gnu.so.2.3.0
