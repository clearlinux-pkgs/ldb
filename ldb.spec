...
Version  : 2.0.8
Release  : 49
URL      : https://www.samba.org/ftp/pub/ldb/ldb-2.0.8.tar.gz
Source0  : https://www.samba.org/ftp/pub/ldb/ldb-2.0.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578446019
...
cp %{_builddir}/ldb-2.0.8/third_party/popt/COPYING %{buildroot}/usr/share/package-licenses/ldb/61bb7a8ea669080cfc9e7dbf37079eae70b535fb
%make_install
...
/usr/lib64/libpyldb-util.cpython-38-x86-64-linux-gnu.so.2.0.8
