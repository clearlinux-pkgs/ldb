...
export LANG=C
export SOURCE_DATE_EPOCH=1553103053
...
/usr/lib64/ldb/libpytalloc-util.cpython-37m-x86-64-linux-gnu.so.2.1.16
/usr/lib64/ldb/libtalloc.so.2
/usr/lib64/ldb/libtalloc.so.2.1.16
/usr/lib64/ldb/libtdb.so.1
/usr/lib64/ldb/libtdb.so.1.3.18
/usr/lib64/ldb/libtevent.so.0
/usr/lib64/ldb/libtevent.so.0.9.39
