...
Version  : 2.1.4
Release  : 58
URL      : https://www.samba.org/ftp/pub/ldb/ldb-2.1.4.tar.gz
Source0  : https://www.samba.org/ftp/pub/ldb/ldb-2.1.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594848061
...
cp %{_builddir}/ldb-2.1.4/third_party/popt/COPYING %{buildroot}/usr/share/package-licenses/ldb/61bb7a8ea669080cfc9e7dbf37079eae70b535fb
%make_install
...
/usr/lib64/libpyldb-util.cpython-38-x86-64-linux-gnu.so.2.1.4
